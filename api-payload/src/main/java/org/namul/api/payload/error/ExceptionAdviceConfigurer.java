...
public class ExceptionAdviceConfigurer {
    ...
    private final Map<Class<? extends Exception>, BaseErrorCode> adviceMap = new HashMap<>();
     ...
     */
    public <E extends Exception> ExceptionAdviceConfigurer addAdvice(Class<E> cls, BaseErrorCode code) {
