...
public interface ExceptionAdviceHandler<E extends Exception> {
     ...
     */
    BaseResponse handleException(E e, HttpServletRequest request, HttpServletResponse response, ErrorReasonDTO errorReasonDTO);
     ...
     */
    default Object getMessage(HttpServletRequest request, E e, ErrorReasonDTO errorReasonDTO) {
        return e.getMessage();
    }
}
